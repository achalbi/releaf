...
class MainActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // modern InsetsController hide() call — the user reported
        // the bar staying visible app-wide on a Xiaomi-family
        // device even with the AndroidX path applied. The older
        // window flag is still respected on those ROMs and forces
