...
// PR #4g moved the iOS generated token files into ReleafCoreDesignSystem.
// Android equivalent moves in PR #4h.
const IOS_REL              = ['shared', 'ios', 'ReleafCore', 'Sources', 'ReleafCoreDesignSystem', 'AppColors.generated.swift'];
const ANDROID_REL          = ['apps', 'releaf', 'android', 'app', 'src', 'main', 'java', 'app', 'releaf', 'mobile', 'ui', 'theme', 'AppColors.generated.kt'];
const IOS_METRICS_REL      = ['shared', 'ios', 'ReleafCore', 'Sources', 'ReleafCoreDesignSystem', 'AppMetrics.generated.swift'];
